...
function(post_target)
	...
	if(PLATFORM STREQUAL "Win64")
		target_compile_definitions(sfml-graphics PRIVATE _CRT_SECURE_NO_WARNINGS)
		target_compile_definitions(sfml-system PRIVATE _CRT_SECURE_NO_WARNINGS)
		target_compile_definitions(sfml-window PRIVATE _CRT_SECURE_NO_WARNINGS)
		if(W_CLANG)
			set(OPTIONS -Wno-missing-braces -Wno-deprecated-declarations)
		elseif(W_VCXX)
			set(OPTIONS /wd4996)
		endif()
		target_compile_options(sfml-graphics PRIVATE ${OPTIONS})
		target_compile_options(sfml-system PRIVATE ${OPTIONS})
		target_compile_options(sfml-window PRIVATE ${OPTIONS})
		if(W_MSBUILD)
